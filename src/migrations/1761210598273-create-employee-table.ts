...
export class CreateEmployeeTable1761210598273 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE "employees" (
                ...
                "personal_mobile_number" character varying(20) NOT NULL,
                ...
                CONSTRAINT "UQ_940a206dda21410c6965108b8bd" UNIQUE ("empId"),
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_EMPLOYEE_EMPID"`);
